Just using this to practice some Objective C as I noticed myself getting a bit rusty. (that's rusty as in not as familiar... Not writing in Rust, although that would be cooler)
